...
public class OrderFulfillmentRecord extends PrimaryKey implements ArrayConvertable {
    ...
    public Object[] toArray() {
        return new Object[] {DateFormat.DATE_TIME.format(this.fulfillDate),
                orderId, sku, quantityPurchased, quantityBought, orderNumber, cost, buyerAccount,
                lastCode, purchaseDate, isbn, seller, character, condition, remark, spreadsheetId,
                sheetName, shippingAddress, fulfilledAddress, fulfilledASIN};
    }


    public static final String[] COLUMNS = {"Fulfill Date", "OrderId", "sku", "quantityPurchased", "quantityBought",
            "orderNumber", "cost", "buyerAccount", "lastCode", "purchaseDate", "isbn", "seller", "character",
            "condition", "remark", "spreadsheetId", "sheetName", "shippingAddress", "fulfilledAddress", "fulfilledASIN"};
