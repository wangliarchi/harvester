...
public class OrderFulfillmentRecord  extends PrimaryKey implements ArrayConvertable {
    ...
    @Column private String sheetName;
    @Column private String spreadsheetId;
    @Column private String purchaseDate;
    @Column private String isbn;
    @Column private String seller;
    @Column private String sellerId;
    @Column private String sellerPrice;
    @Column private String condition;
    @Column private String character;
    @Column private String cost;
    @Column private String orderNumber;
    @Column private String buyerAccount;
    @Column private String lastCode;
    @Column private String remark;
    @Column private int quantityPurchased;
    @Column private int quantityBought;
    @Column private Date fulfillDate;
