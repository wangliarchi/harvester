...
public class FeedGeneratorTest {
    ...
    public void testGenerateConfirmShipmentFeedFromRows() throws Exception {
        ...
        orders.add(new String[]{"701-5618634-6130633","DHL Glabal Mail","2017-09-22"});
        ...
        assertEquals(Tools.readFileToString(feedFile),"order-id\tcarrier-code\tship-date\n" +
                "112-4293495-9496221\tUSPS\t2017-09-22\n" +
                "701-5618634-6130633\tDHL Glabal Mail\t2017-09-22\n" +
