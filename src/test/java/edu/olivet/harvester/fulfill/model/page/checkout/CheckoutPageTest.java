...
public class CheckoutPageTest extends BaseTest {
    ...
    public void detectPage() {
        ...
        browser.loadHTML(Tools.readFileToString(new File(TEST_DATA_ROOT + File.separator + "pages" + File.separator + "PrimeStudent.html")));
        WaitTime.Short.execute();

        assertEquals(CheckoutPage.detectPage(browser), CheckoutPage.AmazonPrimeAd);
    }
